...
- Many people know someone using online dating, or who has found a spouse / long-term partner via online dating


## Dataset:
- Provided by Pew Research Center 
- Survey was completed in 2013 via telephone
- 2,252 adults participated, 185 variables


## Internet, Mobile, & Social Networking

The internet, along with mobile making it easier for us to access the internet, and trendy social networking sites, I wonder if online dating services are capturing all potential markets?




```{r echo=FALSE, cache=FALSE, results=FALSE, warning=FALSE, comment=FALSE, message=FALSE, warning=FALSE}
library(ggplot2)
library(dplyr)
library(ggthemes)
...
sub_online_status=mutate(sub_online,
                         ...
                         date1a_status=factor(
                                 ...
                                 c("Online Dating", "Not Online Dating", 
                                   "Don't Know", "Refused")),
                         date6_status=factor(
                         ...
                         race_status=factor(
                                 ...
                                 c("White American", "Afr. American", "Asian", "Mixed race", 
                         ...
                         educ2_status=ifelse(educ2<=3,"1. H.S. Degree or Less",
                                             ifelse(educ2==4, "2. Some College",
                                                    ifelse(educ2==5, "2. Some College",
                                                           ifelse(educ2==6, "3. 4YR-College",
                                                                  ifelse(educ2==7, "4. Some Postgraduate Schooling",
                                                                         ifelse(educ2==8,"5. Postgraduate Degree",
                                                                                ifelse(educ2==98,"6. Don't Know", "7. Refused")))))))
)
...
g1b + ggtitle("35% are Single and Not in a Committed Relationship") + theme(plot.title = element_text(lineheight=.8, face="bold"))+theme(text = element_text(size=12),axis.text.x = element_text(angle = 45, hjust = 1))
...
g2b + ggtitle("15% of Singles are Looking for Romance")+ theme(plot.title = element_text(lineheight=.8, face="bold"))+theme(text = element_text(size=12),axis.text.x = element_text(angle = 45, hjust = 1))
...
g3b + ggtitle("60% of Singles Looking for Romance are Not Online Dating") + theme(plot.title = element_text(lineheight=.8, face="bold"))+theme(text = element_text(size=12))

```



## The Target By Gender
...
g4c= g4b + ggtitle("Males Looking for Romance are Not Online Dating") + theme(plot.title = element_text(lineheight=.8, face="bold"))+theme(text = element_text(size=12))
...
g5b + ggtitle("The Target are Primarily between the Ages of 18-34") + theme(plot.title = element_text(lineheight=.8, face="bold"))+theme(text = element_text(size=11),axis.text.x = element_text(angle = 45, hjust = 1))

```


## The Target By Education
...
g6b + ggtitle("40% of the Target have a  H.S. Degree or Less") + theme(plot.title = element_text(lineheight=.8, face="bold"))+theme(text = element_text(size=12),axis.text.x = element_text(angle = 45, hjust = 1))

```


## The Target By Ethnicity
...
g7b = g7a + theme_bw() + theme_minimal() + xlab("Ethnicity") + ylab("Percent of Singles Looking for Romance") + coord_cartesian(ylim=c(0,80))
g7b + ggtitle("Over 60% of the Target are White Americans") + theme(plot.title = element_text(lineheight=.8, face="bold"))+theme(text = element_text(size=12),axis.text.x = element_text(angle = 45, hjust = 1))
...
-   Education: With a H.S. Degree or less
