...
fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      fluidRow(column(3, verbatimTextOutput("Price_Range_selected"))),
      ...
      fluidRow(column(3, verbatimTextOutput("Payment_Types_selected"))),
      ...
      fluidRow(column(3, verbatimTextOutput("Days_of_Week_selected"))),
      ...
      fluidRow(column(3, verbatimTextOutput("Times_of_Day_selected")))
