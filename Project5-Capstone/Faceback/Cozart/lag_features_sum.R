...
Client_Prod_Week <- train[, sum(Demanda_uni_equil),by = .(Producto_ID, Cliente_ID, Semana)]
...
write.csv(Client_Prod_Week, "client_product_sum_per_week.csv", row.names = F)
rm(Client_Prod_Week)
gc()
...
write.csv(week11lag8week, "week11lag8weeksum.csv", row.names = F)
...
write.csv(week10lag7week, "week10lag8weeksum.csv", row.names = F)
rm(week10lag7week)
gc()
...
write.csv(week9lag6week, "week9lag8weeksum.csv", row.names = F)
rm(week9lag6week)
gc()
...
write.csv(week8lag5week, "week8lag8weeksum.csv", row.names = F)
rm(week8lag5week)
gc()
...
write.csv(week7lag4week, "week7lag8weeksum.csv", row.names = F)
rm(week7lag4week)
gc()
...
write.csv(week6lag3week, "week6lag8weeksum.csv", row.names = F)
rm(week6lag3week)
gc()
...
write.csv(week5lag2week, "week5lag8weeksum.csv", row.names = F)
rm(week5lag2week)
gc()
...
write.csv(week4lag1week, "week4lag8weeksum.csv", row.names = F)
rm(week4lag1week)
gc()
...
write.csv(week3lag8week, "week3lag8weeksum.csv", row.names = F)
rm(week3lag8week)
gc()
